...
public:
    ...
    void executeSequence(ExecutableConfigurationConstPtr conf, InputGeneratorStrategy* generator, QStringList);
    void detach();

    QWebExecutionListener* webkitListener; // TODO should not be public
    InputGeneratorStrategy* currentGenerator;
    QStringList currentTestcase;
    QMap<QString, int> numsOfEventExecution;
