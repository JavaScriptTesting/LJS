...
void ExecutionResult::getStrings() {
    qDebug() << "Event handlers: " << getEventHandlers() << "\n";
    qDebug() << "Form fields   : " << getFormFields() << "\n";
    qDebug() << "Modfied dom   : " << isDomModified() << "\n";
    qDebug() << "Ajax requests : " << getAjaxRequests() << "\n";
    qDebug() << "Evaled strings: " << getEvalStrings();
}
