...
public:
    ...
    QSharedPointer<const BaseInput> insertAEvent(QSharedPointer<const ExecutableConfiguration> ,QSharedPointer<const ExecutionResult>, QString);
    QSharedPointer<const BaseInput> insertOne(QSharedPointer<const ExecutableConfiguration> oldConfiguration,QSharedPointer<const ExecutionResult> result, QMap<QString, QStringList*>* depMap, QMap<QString, int>* eventNums);
